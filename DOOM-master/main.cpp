...
void crearMenu(void) {
    int menuOpciones, menuAudio, menuControles, menuPrincipal;


    menuOpciones = glutCreateMenu(onMenu);
    glutAddMenuEntry("DIA", RESOLUCION);
    glutAddMenuEntry("NOCHE", RESOLUCION);


    menuAudio = glutCreateMenu(onMenu);
    glutAddMenuEntry("ACTIVAR SONIDO", TECLA);
    glutAddMenuEntry("DESACTIVAR SONIDO", TECLA);
